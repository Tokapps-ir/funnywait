...
import { Product, CalculatorConfig, HeroConfig, FeaturesConfig, FeatureCard, SmartPackage, Package, GalleryItem, GalleryGroup, Testimonial } from './types';
...
const bgMusic = new Howl({
  src: [
    'https://cdn.pixabay.com/download/audio/2026/01/25/audio_1dd7f3126d.mp3?filename=sonican-lo-fi-music-loop-sentimental-jazzy-love-473154.mp3',
    'https://cdn.pixabay.com/download/audio/2022/03/24/audio_7300302061.mp3?filename=ambient-night-sky-10653.mp3',
...
const transitionSound = new Howl({
  src: ['https://cdn.pixabay.com/download/audio/2024/01/02/audio_2e76a96686.mp3?filename=trading_nation-deep-strange-whoosh-183845.mp3'],
  volume: 0.12,
  html5: true,
  preload: true,
});
...
const whooshSound = new Howl({
  src: ['https://cdn.pixabay.com/audio/2022/03/15/audio_115b9b3838.mp3'],
  volume: 0.08,
  html5: true,
  preload: true,
});
  ...
  return (
    ...
    <SmoothScroll>
      <div className="relative min-h-screen">
        ...
        {/* Navigation */}
        <nav className="fixed top-0 left-0 right-0 z-50 px-8 py-5 flex justify-between items-center backdrop-blur-xl bg-black/20 border-b border-white/5">
          ...
          <div className="flex items-center gap-4">
            ...
            <button className="bg-white text-black px-6 py-2 rounded-full text-sm font-bold hover:bg-emerald-500 hover:text-white transition-all">
              {t('nav_cta')}
            </button>
          </div>
        </nav>
